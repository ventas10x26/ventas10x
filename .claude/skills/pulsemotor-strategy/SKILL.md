...
- Los prompts de sistema de Claude para generar la config del agente (`generarConIA` en `configure-agent/route.ts`, `regenerarConIA` en `agente/route.ts`) ya reciben la marca real en vez de decir literalmente "asesores KIA Colombia".
