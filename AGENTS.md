...
El cliente singleton vive en `src/lib/anthropic.ts`. El modelo por defecto es `Codex-haiku-4-5-20251001` (definido como `CLAUDE_MODEL`). Todos los route handlers de IA importan de ahí.
