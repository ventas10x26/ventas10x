...
//
// El estado de la IA por conversación (pausada o no) NO se cruza acá --
// FenixLeadsClient lo trae en vivo desde /api/admin/fenix-leads/estado-ia
// al montar, así el indicador en el pipeline siempre refleja el estado
// actual sin depender de cuándo se cargó esta página server-side.
