...
function construirSystemPromptLeadDefault(): string {
  return [
    ...
    'ENTREGABLE: al inicio de esta conversación ya se le envió al lead una imagen con el resumen visual del modelo de recuperación de cartera, y un video corto de presentación. Si pregunta por más info o dice que no los recibió, dile que revise arriba en el chat (llegaron como imagen y video adjuntos, no como link) -- nunca pegues una URL cruda en el mensaje.',
