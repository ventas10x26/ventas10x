...
// Este componente es el que era antes "page.tsx" completo, movido acá sin cambiar
// una sola linea de su contenido o comportamiento. page.tsx ahora es un componente
// de servidor liviano que solo declara metadata (title/description/canonical
// propios de esta pagina, algo que un componente de cliente no puede hacer en
// Next.js) y renderiza este componente. Ver comentario en page.tsx.
export default function ConcesionarioClient() {
