...
function PostModal({ post, onClose, onConectar, logueado }: { post: Post; onClose: () => void; onConectar: () => void; logueado: boolean }) {
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflowY: 'auto' }}>
          ...
          <div style={{ padding: '16px 20px', borderTop: '1px solid rgba(255,255,255,.07)', display: 'flex', gap: '10px' }}>
            <a
              ...
              onClick={e => { if (!logueado) { e.preventDefault(); window.location.href = '/auth/register' } }}
    ...
    <div style={{ minHeight: '100vh', background: DARK, fontFamily: "'Inter', system-ui, sans-serif", color: '#f1f5f9' }}>
      ...
      {postDetalle && (
        <PostModal
          ...
          onConectar={() => { if (!logueado) { window.location.href = '/auth/register'; return; } setPostConectar(postDetalle); setPostDetalle(null) }}
          logueado={logueado}
        />
      )}
