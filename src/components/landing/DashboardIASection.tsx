    ...
    <div ref={sectionRef} style={{ background: DARK, padding: '6rem 2rem', borderTop: '1px solid rgba(255,255,255,.07)' }}>
      <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
        ...
        <div className="dashboard-ia-grid">
          ...
          <div style={{ background: 'rgba(255,255,255,.04)', border: '1px solid rgba(255,255,255,.1)', borderRadius: '20px', overflow: 'hidden' }}>
            ...
            <div ref={chatRef} style={{ padding: '1rem', height: '280px', overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: '10px', scrollBehavior: 'smooth' }}>
              {shownMsgs.map((msg, i) => (
                <div key={i} style={{ display: 'flex', justifyContent: msg.role === 'user' ? 'flex-end' : 'flex-start', animation: 'fadeUp .3s ease' }}>
                  <div style={{ maxWidth: '80%', padding: '8px 12px', borderRadius: msg.role === 'user' ? '14px 14px 4px 14px' : '14px 14px 14px 4px', background: msg.role === 'user' ? ORANGE : 'rgba(255,255,255,.1)', color: '#fff', fontSize: '13px', lineHeight: 1.5, fontWeight: 400 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <div style={{ background: 'rgba(255,255,255,.04)', border: '1px solid rgba(255,255,255,.1)', borderRadius: '16px', padding: '1.25rem' }}>
              ...
              <div style={{ fontSize: '15px', fontWeight: 700, color: '#fff', transition: 'color .3s', lineHeight: 1.4 }}>{titleText}</div>
              <div style={{ fontSize: '12px', color: 'rgba(255,255,255,.35)', marginTop: '6px' }}>ventas10x.co/u/concesionario-kia</div>
            </div>
          </div>
        </div>
