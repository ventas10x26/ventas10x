...
interface Props {
  onAgotado?: () => void  // callback cuando llega a 0
}
  ...
  useEffect(() => {
    ...
    const channel = supabase
      ...
      .on('postgres_changes', {
        ...
        const nuevo = payload.new as CreditosData
        setCreditos(nuevo)
        if (nuevo.saldo <= 0) {
          setShowPaywall(true)
          onAgotado?.()
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          {esCritico && (
            <p style={{ fontSize: '11px', color: '#f87171', marginTop: '5px' }}>
              ⚠ Créditos casi agotados — activá tu plan para seguir sin interrupciones
            </p>
          )}
          {esBajo && (
            <p style={{ fontSize: '11px', color: '#fbbf24', marginTop: '5px' }}>
              Créditos bajos — considerá activar el plan ilimitado
            </p>
          )}
        </div>
        ...
        {(esCritico || esBajo) && (
          <a
            ...
            style={{
              ...
              padding: '6px 14px',
              borderRadius: '8px',
              background: esCritico ? 'linear-gradient(135deg,#f87171,#ef4444)' : 'linear-gradient(135deg,#10b981,#059669)',
              color: '#fff',
              fontSize: '12px',
              fontWeight: 700,
              textDecoration: 'none',
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              background: 'rgba(248,113,113,0.1)', border: '2px solid #f87171',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              fontSize: '28px', margin: '0 auto 20px',
            }}>🔴</div>

            <h2 style={{ fontFamily: FONT, fontSize: '22px', fontWeight: 700, color: '#f8fafc', marginBottom: '10px' }}>
            ...
            <p style={{ fontSize: '11px', color: '#334155' }}>
              Sin tarjeta para empezar · Cancelás cuando querás · Garantía 7 días
            </p>
            ...
            <div style={{
              ...
              <p style={{ fontSize: '11px', color: '#10b981', fontWeight: 700, marginBottom: '8px', textTransform: 'uppercase', letterSpacing: '1px' }}>
                El math
              </p>
